...
[ "$DEMO_LLM_PROVIDER" = "xiaomi-mimo" ] && \
  echo "  ⚠️  default baseUrl (https://api.xiaomimimo.com/v1) and model (mimo-v2.5-pro) are placeholders — set DEMO_LLM_BASE_URL / DEMO_LLM_MODEL to match the real Xiaomi Mimo endpoint"
